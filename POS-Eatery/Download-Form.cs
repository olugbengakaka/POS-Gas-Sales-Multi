        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                if (dr27 == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        //  gclass.display_in_dgv_online("SELECT* FROM table_sales_confirmed WHERE Day='" + from.Value.Day + "' AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView2, str200);
                        gclass.display_in_dgv_online("SELECT* FROM table_sales_confirmed WHERE (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView2, str200);

                        // SYNCHRONIZATION FOR DAILY METER READING IN KG ************************************************************8
                        if (daily_meter_reading.Checked == true)
                            {
                                gclass.display_in_dgv_online("SELECT* FROM TABLE_CLOSING_STOCK_GAS where (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' AND branch='" + branch.Text + "'", dataGridView1,str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_sales WHERE Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "' AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                                {
                                    ...
                                    try
                                    {
                                        MySqlConnection cn = new MySqlConnection(ConfigurationManager.ConnectionStrings["cnstring"].ConnectionString);
                                        cn.Open();
                                        string query = "INSERT INTO table_sales(Customer_Name,Customer_ID,Quantity,Product_Name,Category,Bar_Code,Price,Amount_Paid,Balance,Date,Day,Month,Year,Comment,Employee,Code,Payment_Method,Discount,Receipt_No,Branch)VALUES('" + dataGridView1.Rows[i].Cells[1].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[2].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[3].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[4].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[5].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[6].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[7].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[8].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[9].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[10].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[11].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[12].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[13].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[14].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[15].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[16].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[17].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[18].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[19].Value.ToString() + "','" + dataGridView1.Rows[i].Cells[20].Value.ToString() + "') ON DUPLICATE KEY UPDATE customer_name=values(customer_name),customer_id=values(customer_id),quantity=values(quantity),product_name=values(product_name),Category=values(category),bar_code=values(bar_code),Price=values(price),amount_paid=values(amount_paid),balance=values(balance),Date=values(date),day=values(day),month=values(month),year=values(year),comment=values(comment),employee=values(employee),code=values(code),payment_method=values(payment_method),discount=values(discount),Receipt_No=values(Receipt_No)";
                                        MySqlCommand cmd = new MySqlCommand(query, cn);
                                        cmd.ExecuteNonQuery();
                                        cn.Close();
                                    }
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_sales_confirmed WHERE Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "' AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_loyalty WHERE branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_sales_lump WHERE (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_repayment WHERE (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_expenditure WHERE (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_expenditure_list where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            /////// FIRST PHASE FOR STOCK_INVENTORY_SUMMARY
                            String frm1 = from.Value.Month + "/" + from.Value.Day + "/" + from.Value.Year;
                            String t1 =  to.Value.Month+ "/" + to.Value.Day + "/" + to.Value.Year;
                            gclass.display_in_dgv_online("SELECT* FROM table_stock_inventory_summary WHERE str_to_date(Date, '%m/%d/%Y')>=str_to_date('" + frm1 + "', '%m/%d/%Y') AND str_to_date(Date, '%m/%d/%Y')<=str_to_date('" + t1 + "', '%m/%d/%Y') and branch='" + branch.Text + "'", dataGridView1, str200);
                            //SELECT * FROM `table_stock_inventory_summary` WHERE str_to_date(Date, '%m/%d/%Y')>=str_to_date('4/22/2021', '%m/%d/%Y') AND str_to_date(Date, '%m/%d/%Y')<=str_to_date('4/23/2021', '%m/%d/%Y')
                            // gclass.display_in_dgv_online("SELECT* FROM table_stock_inventory_summary WHERE (Day>='" + from.Value.Day + "' and Day<='" + to.Value.Day + "') AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_employee where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_login where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_new_product where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_buyers WHERE Day='" + from.Value.Day + "' AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_customize", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_price_product where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_unit where branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_customer WHERE Branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_act", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_in WHERE Day='" + from.Value.Day + "' AND Month='" + from.Value.Month + "' AND Year='" + from.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            MessageBox.Show("Local Database Successfully Updated ...");
                        }
                    }
                    catch (Exception ex)
                    {
