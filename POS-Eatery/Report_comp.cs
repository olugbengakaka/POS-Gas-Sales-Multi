    ...
    public partial class Report_comp : Form
    {
      ...
      //  }
        ...
        private void year_pos_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',Transfer AS 'Transfer Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
            else if (comboBox1.Text == "POS")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',POS AS 'POS Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
            else if (comboBox1.Text == "Cash")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',Cash AS 'Cash Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
            else if (comboBox1.Text == "Credit")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Sales_Method AS 'Sales Method',Discount,Item_Value AS 'Item Value',Amount_Paid AS 'Amount Paid',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' AND Payment_Method='" + comboBox1.Text + "' and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
        ...
        private void month_pos_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (comboBox1.Text == "Transfer")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',Transfer AS 'Transfer Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' and month='" + month_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
            else if (comboBox1.Text == "POS")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',POS AS 'POS Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' and month='" + month_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
        ...
        private void day_pos_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if (comboBox1.Text == "Transfer")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',Transfer AS 'Transfer Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' and month='" + month_pos.Text + "' and day='" + day_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
            }
            else if (comboBox1.Text == "POS")
            {
                gclass.display_in_dgv("SELECT Sales_ID AS 'Sales ID',Customer_Name AS 'Name of Customer',Category,Payment_Method AS 'Method of Payment',Discount,Item_Value AS 'Item Value',POS AS 'POS Amount',(Item_Value-Amount_Paid) AS Balance,Receipt_No,Short_Code,Employee as 'Sales Person' FROM Table_Sales_lump WHERE year='" + year_pos.Text + "' and month='" + month_pos.Text + "' and day='" + day_pos.Text + "' AND " + comboBox1.Text + ">0 and branch='" + branch.Text + "'  order by p_id DESC", dataGridView1);
