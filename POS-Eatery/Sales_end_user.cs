                ...
                if (Convert.ToDecimal(discount1.Text) > 0)
                {
                    ...
                    if (productname1.Text.Contains("Gas") || productname1.Text.Contains("gas") || productname1.Text.Contains("GAS"))
                    {
                        ...
                        else
                        {
                          ...
                          if (Convert.ToInt32(no_of_appearance.Text) > Convert.ToInt32(benchmark.Text) && channel.Text.Contains("End") && (productname1.Text.Contains("Gas") || productname1.Text.Contains("gas") || productname1.Text.Contains("GAS")) || Convert.ToInt32(no_of_appearance.Text) > Convert.ToInt32(benchmark.Text) && channel.Text.Contains("Home") && (productname1.Text.Contains("Gas") || productname1.Text.Contains("gas") || productname1.Text.Contains("GAS")))
                            {
            ...
            if (!channel.Text.Contains("Indus"))
            {
                ...
                else
                {
                  ...
                  /*  if (payment_pos.Checked == true)
                    ...
                    if (Sales_Method.Text.Contains("Cash") || Sales_Method.Text.Contains("POS") || Sales_Method.Text.Contains("Transfer") || Sales_Method.Text.Contains("Multiple"))
                    {
