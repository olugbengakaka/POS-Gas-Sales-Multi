...
namespace POS_Eatery
{
    public partial class Home : Form
    {
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            ...
            /*  //////////////////////////////////////////////////////////////////////////////////////////////////////////////
              if (Environment.MachineName.ToString() == "SERVER")
              {
                  try
                  {
                      gclass.get_on(webBrowser1, g_school);
                      System.Threading.Thread.Sleep(3);
                      DialogResult dr27 = MessageBox.Show("Internet Connection is needed to Update Stock Price. \n \nDo you really want to Update Price ? \n \n Click OK to Continue", "  Message from Monitoring Server: ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                      if (dr27 == DialogResult.OK)
                      {
                          String str200 = Convert.ToString(webBrowser1.Document.GetElementById("content").OuterText).Trim().TrimEnd();
                          ...
                          {
                              //////////////////////////////////////////////////////////////////////////////////////////////
                              gclass.display_in_dgv_online("SELECT* FROM table_price_product where branch='" + cmb_school.Text + "'", dataGridView2, str200);

                              gclass.display_in_dgv_online("SELECT* FROM table_loyalty where branch='" + cmb_school.Text + "'", dataGridView3, str200);
                              ...
                              for (int i = 0; i < dataGridView2.Rows.Count; i++)
                              {
                                  ...
                                  try
                                  {
                                      ...
                                      String query = "UPDATE table_price_product SET price='" + dataGridView2.Rows[i].Cells[2].Value.ToString() + "' where category='" + dataGridView2.Rows[i].Cells[6].Value.ToString() + "' AND branch='" + dataGridView2.Rows[i].Cells[8].Value.ToString() + "' and product_name='" + dataGridView2.Rows[i].Cells[1].Value.ToString() + "'";
                              ...
                              for (int i = 0; i < dataGridView3.Rows.Count; i++)
                              {
                                  ...
                                  {
                                      cn.Open();
                                      String query = "UPDATE table_loyalty SET amount='" + dataGridView3.Rows[i].Cells[2].Value.ToString() + "' where branch='" + dataGridView3.Rows[i].Cells[3].Value.ToString() + "'";
                                      MySqlCommand cmd = new MySqlCommand(query, cn);
                                      cmd.ExecuteNonQuery();
                                      cn.Close();
                                  }
                              ...
                              for (int i = 0; i < dataGridView1.Rows.Count; i++)
                              {
                                  ...
                                  {
                                      MySqlConnection cn = new MySqlConnection(ConfigurationManager.ConnectionStrings["cnstring"].ConnectionString);
                                      cn.Open();//DELETE FROM table_customer WHERE Branch='" + branch.Text + "';
                              ...
                              /////////////////////////////////////////////////////////////////////////////////////////////
                              MessageBox.Show("Price Update was successful..", "  Message from Monitoring Server: ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                          }
                      }
                      else
                      {
                          MessageBox.Show("Fail to Update Price. \n\n Check your Internet Connection", "  Message from Monitoring Server: ", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                      }
            ...
            try
            {
                ...
                if (dr27 == DialogResult.OK)
                {
                    ...
                    //  System.Threading.Thread.Sleep(3);
                    // MessageBox.Show(str200);
                    MessageBox.Show("Click OK Button to Continue ...", "Confirmation Response", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    if (str200 != "")
                    {
                        //////////////////////////////////////////////////////////////////////////////////////////////
                        gclass.display_in_dgv_online("SELECT* FROM table_price_product where branch='" + cmb_school.Text + "'", dataGridView2, str200);
